...
function ProfileSkeleton() {
  return (
    <div className="profile-skeleton" aria-label="Loading player profile" role="status">
      <Skeleton height={238} />
      <div>
...
export function ProfilePage() {
  ...
  if (query.isError || !query.data)
    return (
      <StatePanel
        ...
        description="This profile may not exist, or Gamerie could not load it right now."
        action={
  ...
  return (
    <main className="profile-page">
      <ProfileHeader own={own} profile={query.data} />
