...
export function CookieConsent() {
  ...
  const save = (next: DraftConsent) => {
    ...
    if (stored.analytics) trackPageView(`${window.location.pathname}${window.location.search}`);
  };

  return (
    <>
      {!consent && !preferencesOpen ? (
        <aside className="cookie-banner" role="region" aria-label="Cookie choices">
          <div>
            <strong>Your privacy, your choice.</strong>
            <p>
              Gamerie uses necessary cookies to keep the platform secure. With your permission,
              analytics cookies help us understand and improve the experience.
            </p>
            <a href={publicLinks.cookie}>Read the Cookie Policy</a>
          </div>
      ...
      {preferencesOpen ? (
        <div className="cookie-dialog-backdrop" role="presentation">
          ...
          >
            ...
            <div className="cookie-dialog__choices">
              <article>
                <div>
                  ...
                  <p>Required for sign-in, security, and core platform functionality.</p>
                </div>
                <span>Always on</span>
              </article>
              <label>
                <div>
                  ...
                  <p>Helps us understand product usage and improve Gamerie.</p>
                </div>
                <input
                  type="checkbox"
              ...
              <label>
                <div>
                  ...
                  <p>Allows campaign measurement and relevant promotional tracking.</p>
                </div>
                <input
                  type="checkbox"
            ...
            <footer>
              <a href={publicLinks.cookie}>Cookie Policy</a>
              <button className="is-primary" type="button" onClick={() => save(draft)}>
                Save preferences
              </button>
            </footer>
          </section>
  ...
  return (
    <section className="cookie-settings-card">
      <div>
        ...
        <span>Review or withdraw optional analytics and marketing consent at any time.</span>
      </div>
      <button type="button" onClick={() => window.dispatchEvent(new Event(COOKIE_SETTINGS_EVENT))}>
        Manage cookies
      </button>
    </section>
  );
