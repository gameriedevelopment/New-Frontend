...
type ChangeState =
  { status: "working" } | { status: "done"; email: string } | { status: "failed"; message: string };
        ...
        <section className="auth-panel auth-process">
          {state.status === "working" ? (
            <>
              ...
              <h2 id="confirm-change-title">Updating your email.</h2>
              <p>Please keep this page open for a moment.</p>
            </>
          ) : state.status === "done" ? (
            <>
              <h2 id="confirm-change-title">Email updated.</h2>
              <p>
                Your account now uses <strong>{state.email || "the new email address"}</strong>.
              </p>
              <Link className="auth-submit auth-process__action" to="/feed">
            ...
            <>
              ...
              <h2 id="confirm-change-title">Email not updated.</h2>
              <p>{state.message}</p>
