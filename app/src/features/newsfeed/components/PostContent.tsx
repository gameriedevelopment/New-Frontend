...
export function PostContent({ content, single = false }: { content: string; single?: boolean }) {
  ...
  return (
    <div
      ...
      data-overflowing={overflowing && !expanded}
    >
      <div id={contentId} ref={contentRef} className="post-content__viewport">
        <RichText content={content} />
      </div>
      {overflowing || (expanded && !single) ? (
        <button
          type="button"
          className="post-content__toggle"
