...
export function AppShell() {
  useHeartbeat();
  const [sidebarCollapsed, setSidebarCollapsed] = useState(() => localStorage.getItem("Gamerie_sidebar_collapsed") === "true");
  ...
  return (
    <div className="app-shell" data-sidebar={sidebarCollapsed ? "collapsed" : "expanded"}>
      ...
      <div className="app-shell__workspace">
        <AppHeader />
        <main className="app-shell__content" id="main-content" tabIndex={-1}><Outlet /></main>
      </div>
      <MobileNavigation />
    </div>
  );
